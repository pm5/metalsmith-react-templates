...
/**
 * Extensions for `require` to ignore css
 * If you use webpack, you might be importing css inside js code.  This extension ignores these files to eliminate error.
 */
function requireIgnore(module, filename) {
  return null;
}
...
function renderReactTemplate(str, options, fn){
  ...
  if (!require.extensions['.css']) {
    require.extensions['.css'] = requireIgnore;
  }
